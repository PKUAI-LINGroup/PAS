...
def main(args):
    ...
    Iteration = 10
    model.load_state_dict(torch.load('/mnt/lustrefs/home/wangyh/home1/SNLI/pre+fine+self/CL_checkpoints/' + f'iteration{Iteration}_supervised_weights'))
    train_supervised(model, train_loader, dev_loader, args, writer)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/SNLI/')
    parser.add_argument('--supervised_epoch', type=int, default=10)
    parser.add_argument('--checkpoints_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/SNLI/pre+fine+self+fine/checkpoints/')
    parser.add_argument('--save_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/SNLI/pre+fine+self+fine/iter_data/')
