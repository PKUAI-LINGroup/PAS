...
class Parallel(Dataset):
    def __init__(self, directory=None, split=None, tokenizer=None, in_list=False, L=None):
        ...
        if in_list:
            ...
            self.data = [(tokenizer.encode(line[0], max_length=120, padding='max_length', truncation=True), line[1]) for line in lines]
    def __len__(self):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/mnt/lustrefs/home/wangyh/home1/MultiNLI/')
