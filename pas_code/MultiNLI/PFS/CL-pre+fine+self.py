...
if __name__ == '__main__':
    ...
    parser.add_argument('--supervised_epoch', type=int, default=15)
    parser.add_argument('--checkpoints_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/MultiNLI/pre+fine+self/CL_checkpoints/')
    parser.add_argument('--save_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/MultiNLI/pre+fine+self/CL_iter_data/')
