...
def convert_ids_to_str(ids, tokenizer):
    ...
    for token_id in ids:
        ...
        tokens.append(token)
    outputs = utils.rev_wordpiece(tokens)
    return outputs
...
def main():
    ...
    ## required parameters
    parser.add_argument("--data_dir", default="/mnt/lustrefs/home/wangyh/home1/", type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--output_dir", default="/mnt/lustrefs/home/wangyh/home1/imdb/cbert/1000aug_data/", type=str,
                        help="The output dir for augmented dataset")
    parser.add_argument("--save_model_dir", default="/mnt/lustrefs/home/wangyh/home1/imdb/cbert_model", type=str,
                        help="The cache dir for saved model.")
    parser.add_argument("--bert_model", default="prajjwal1/bert-medium", type=str,
    ...
    parser.add_argument('--sample_num', default=1, type=int,
                        help="sample number")
    parser.add_argument('--sample_ratio', default=2, type=int,
                        help="sample ratio")
    ...
    """prepare processors"""
    AugProcessor = utils.AugProcessor()
    processors = {
    ...
    shutil.copytree("/mnt/lustrefs/home/wangyh/home1/imdb/aug_data/{}".format(task_name), args.output_dir)

    ## prepare for training
    train_examples = processor.get_train_examples(args.data_dir)
    train_features, num_train_steps, train_dataloader = \
        utils.construct_train_dataloader(train_examples, label_list, args.max_seq_length,
    ...
    MASK_id = utils.convert_tokens_to_ids(['[MASK]'], tokenizer)[0]

    origin_train_path = os.path.join(args.data_dir, "imdbback1.tsv")
    save_train_path = os.path.join(args.output_dir, "train.tsv")


    for e in trange(int(args.num_train_epochs), desc="Epoch"):
        torch.cuda.empty_cache()
        cbert_name = "/mnt/lustrefs/home/wangyh/home1/imdb/cbert_model/imdb/BertForMaskedLM_{}_epoch_{}".format(task_name.lower(), e + 1)
        ...
        '''best_test_acc = train_text_classifier.train(
            "aug_data_{}_{}_{}_{}".format(args.sample_num, args.sample_ratio, args.gpu, args.temp))
