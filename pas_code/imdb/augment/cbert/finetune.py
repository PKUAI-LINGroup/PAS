...
def main():
    ...
    parser.add_argument("--output_dir", default="/mnt/lustrefs/home/wangyh/home1/imdb/aug_data/", type=str,
    ...
    if task_name == 'stsa.fine':
        model.bert.embeddings.token_type_embeddings = torch.nn.Embedding(5, 512)
        model.bert.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0, std=0.02)
    elif task_name == 'TREC':
        model.bert.embeddings.token_type_embeddings = torch.nn.Embedding(6, 512)
        model.bert.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0, std=0.02)
    elif task_name == 'agnews':
        model.bert.embeddings.token_type_embeddings = torch.nn.Embedding(4, 512)
        model.bert.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0, std=0.02)
    elif task_name == 'imdb':
        model.bert.embeddings.token_type_embeddings = torch.nn.Embedding(2, 512)
        model.bert.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0, std=0.02)
