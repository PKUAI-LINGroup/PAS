...
def main(args):
    ...
    model.load_state_dict(torch.load(args.checkpoints_dir+f'iteration19_supervised_weights'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoints_dir', type=str, default='/home1/wangyh/elec/self/checkpoints/')
