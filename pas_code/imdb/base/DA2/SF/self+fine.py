...
def main(args):
    ...
    Iteration = 10
    model.load_state_dict(torch.load('/mnt/lustrefs/home/wangyh/home1/imdb/base/S2self/CL_checkpoints/' + f'iteration{Iteration}_supervised_weights'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoints_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/imdb/base/S2/self+fine/checkpoints/')
    parser.add_argument('--save_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/imdb/base/S2/self+fine/iter_data/')
