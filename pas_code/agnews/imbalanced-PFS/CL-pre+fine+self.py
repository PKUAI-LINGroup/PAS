...
if __name__ == '__main__':
    ...
    parser.add_argument('--supervised_epoch', type=int, default=12)
    parser.add_argument('--checkpoints_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/agnews/imba-pre+fine+self/CL_checkpoints/')
    parser.add_argument('--save_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/agnews/imba-pre+fine+self/CL_iter_data/')
