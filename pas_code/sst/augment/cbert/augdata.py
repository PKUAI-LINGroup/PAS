...
def main():
    ...
    parser.add_argument("--output_dir", default="/mnt/lustrefs/home/wangyh/home1/sst/cbert/1000aug_data/", type=str,
                        help="The output dir for augmented dataset")
    parser.add_argument("--save_model_dir", default="/mnt/lustrefs/home/wangyh/home1/sst/cbert_model", type=str,
    ...
    shutil.copytree("/mnt/lustrefs/home/wangyh/home1/sst/aug_data/{}".format(task_name), args.output_dir)
    ...
    origin_train_path = os.path.join(args.data_dir, "sstback1.tsv")
    save_train_path = os.path.join(args.output_dir, "train.tsv")


    for e in trange(int(args.num_train_epochs), desc="Epoch"):
        torch.cuda.empty_cache()
        cbert_name = "/mnt/lustrefs/home/wangyh/home1/sst/cbert_model/sst/BertForMaskedLM_{}_epoch_{}".format(task_name.lower(), e + 1)
