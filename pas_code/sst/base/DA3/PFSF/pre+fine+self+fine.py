...
def main(args):
    ...
    if not os.path.exists(args.save_dir):
        os.makedirs(args.save_dir)
    trainset = Parallel(args.data_dir, "sst-S3", tokenizer)
    ...
    Iteration = 10
    model.load_state_dict(torch.load('/mnt/lustrefs/home/wangyh/home1/sst/base/S3pre+fine+self/CL_checkpoints/' + f'iteration{Iteration}_supervised_weights'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoints_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/sst/base/S3pre+fine+self+fine/checkpoints/')
    parser.add_argument('--save_dir', type=str, default='/mnt/lustrefs/home/wangyh/home1/sst/base/S3pre+fine+self+fine/iter_data/')
